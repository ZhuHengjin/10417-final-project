...
python3 ./report/visualize_umap.py --mode predict \
  --ckpt save/student_model/S:resnet8x4_T:resnet32x4_cifar100_crd_sw_r:1_a:0.0_b:0.8_sw:1.0_tau:0.5_1/resnet8x4_best.pth \
...
python3 report/visualize_umap.py --mode plot --csv ./report/umap_log/crd_sw_1.0_0.5.csv --out report/graphs/crd_sw_1.0_0.5_umap_-60.png --rotate-deg -60

python3 report/visualize_umap.py --mode plot --csv ./report/umap_log/crd.csv --out report/graphs/crd_umap_-60.png --rotate-deg -60
