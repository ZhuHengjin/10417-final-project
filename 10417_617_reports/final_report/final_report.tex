...
\subsection{Ablation Study and Hyper-Parameters}
...
\begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{../../report/graphs/tau_tuning_plot.png}
...
\begin{subfigure}[t]{0.49\textwidth}
    ...
    \caption{Effects of varying $\tau_{\text{SW}}$}
    \label{fig:sematic-tau-tuning}
\end{subfigure}

\caption{Effects of varying (a) the number of negatives, shown in , or (b) the semantic wieghting temperature.}
\label{fig:hyperparameter-tuning}
\end{figure}

\textbf{Temperature $\tau_{\text{SW}}$} We experimented with different temperature values $\tau_{\text{SW}}$ in the semantic weight function $w(T,S)$ (Eq.~\ref{def:semantic-weights}) from 0.05 to 1.
